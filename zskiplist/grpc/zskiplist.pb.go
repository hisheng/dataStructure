...
// ZskiplistClient is the client API for Zskiplist service.
//
...
func NewZskiplistClient(cc *grpc.ClientConn) ZskiplistClient {
	return &zskiplistClient{cc}
}

func (c *zskiplistClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/dataStructure.hisheng.zskiplist.Zskiplist/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UnimplementedZskiplistServer struct {
}
...
func RegisterZskiplistServer(s *grpc.Server, srv ZskiplistServer) {
	s.RegisterService(&_Zskiplist_serviceDesc, srv)
}

func _Zskiplist_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ZskiplistServer).SayHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dataStructure.hisheng.zskiplist.Zskiplist/SayHello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ZskiplistServer).SayHello(ctx, req.(*HelloRequest))
	}
